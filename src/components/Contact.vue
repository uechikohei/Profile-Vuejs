  ...
  <v-app style="background-color: #f4f9e2">
    <v-container class="footer">
      ...
      <v-layout justify-center text-center>
        <div data-aos="fade-up" style="color: grey" class="font__s">
          <h3>現在、転職活動中です。</h3>
          <br />
          <h5>
            オファー頂ける方いらっしゃいましたら、<br />是非ご連絡お待ちしております！
          </h5>
          <br />
          <p style="color: #e06a3b">
            24時間以内に返信させて頂きますので<br />受信可能なメールアドレスをご指定下さい
          </p>
          <br />
          <h5>
            希望勤務地: 東京、大阪、福岡、愛知<br />（現在大阪在住、転職に伴い引っ越しを予定）
          </h5>
          <br />
          <h5>希望年収: 200万円以上</h5>
        </div>
